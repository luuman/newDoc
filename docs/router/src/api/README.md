...
| :book: `uploadApi.js`           |          |                                                                     |                |                                                         |
| uploadLogInit                   | P PFM/UC | <i title="/pfm/log/init">Copy</i>                                   | {},idcUrl      | 文件上传初始化                                          |
| uploadLogComplete               | P PFM/UC | <i title="/pfm/log/complete">Copy</i>                               | {},idcUrl      | 文件上传中                                              |
| uploadLog                       | P PFM/UC | <i title="/pfm/log/upload">Copy</i>                                 | {},idcUrl      | 文件上传完成生成地址                                    |
| uploadLogInit                   | P PFM/UC | <i title="/pfm/logFile/init">Copy</i>                               | {},idcUrl      | 文件上传初始化                                          |
| uploadLogComplete               | P PFM/UC | <i title="/pfm/logFile/complete">Copy</i>                           | {},idcUrl      | 文件上传中                                              |
| uploadLog                       | P PFM/UC | <i title="/pfm/logFile/upload">Copy</i>                             | {},idcUrl      | 文件上传完成生成地址                                    |
| :book: `userApi.js`             |          |                                                                     |                |                                                         |
